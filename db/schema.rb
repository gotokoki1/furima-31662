...
ActiveRecord::Schema.define(version: 2020_11_08_040346) do
  ...
  create_table "delivery_addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["item_user_id"], name: "index_delivery_addresses_on_item_user_id"
  end
  ...
  add_foreign_key "delivery_addresses", "item_users"
